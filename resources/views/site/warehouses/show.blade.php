...
@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{url('warehouses')}}">{{label('lbl_warehouses')}}</a></li>
<li class="breadcrumb-item active" aria-current="page">{!! str_limit(strip_tags($warehouse->name) ,20) !!}</li>
@endsection
                    ...
                    <div class="col-12 py-1 px-0 ">
                        <h5 class="pb-2 position-relative page-title text-uppercase text-primary hover-text-primary"> 
							<span class="d-inline-block py-2 position-relative text-bold text-primary">
							  <span class="px-2222"> {!! $warehouse->name !!}</span>
							</span>
                    ...
                    <div class="col-12  border-bottom-faded">
                        <div class="py-3">
                            <span class="text-muted bold-600 d-inline-block mr-4">
                                <i class="fa fa-calendar-alt mr-1"></i> {!! date('d M, Y', strtotime($warehouse->created_at)) !!}
                            </span>
