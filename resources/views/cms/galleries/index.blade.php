                          ...
                          @foreach($type as $key => $gallery)                              
                            ...
                            <figure class="effect-kira">
                              ...
                              @if (count($gallery->photos) > 1 && ($title == 'photos'))
                                <img loading="lazy" src="{{ asset($gallery->photos->first()->image())}}" class="w-100" style="min-height: 150px">
                              
			      @else
                                <img loading="lazy" src="{{ asset('admin/images/1.jpg')}}" class="w-100" style="min-height: 150px">
                              @endif
                              <figcaption>
                              <h2>
                                @if ($title == 'photos')
