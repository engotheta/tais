					...
					<div class="row align-items-center">
							<div class="col-md-7">
									<div class="page-header-title">
											{{-- <h5 class="m-b-10">Support Links</h5> --}}
											<h5 class="m-b-10">Consumer Services Links</h5>
									</div>
									<ul class="breadcrumb">
											<li class="breadcrumb-item"><a href="{{ url('/cms') }}"><i class="feather icon-home"></i></a></li>
											<li class="breadcrumb-item"><a href="javascript:">Site Contents</a></li>
											<li class="breadcrumb-item"><a href="javascript:">Links</a></li>
											{{-- <li class="breadcrumb-item"><a href="javascript:">Support Links</a></li> --}}
													<li class="breadcrumb-item"><a href="javascript:">Consumer Services Links</a></li>
									</ul>
							</div>
	...
	<div class="main-body">
			<div class="page-wrapper">
				<div class="row">
					...
					<div class="col-md-4">
						<div class="card">
							{{-- <div class="card-header" > <h5>New Support Link</h5></div> --}}
							<div class="card-header" > <h5>Consumer Services Links</h5></div>
							<div class="card-body">
								{!! Form::open(['route' => 'cms.support_links.index']) !!}

									@include('cms.support_links._form', ['submitButton' => "Save"])
					...
					<div class="col-md-8">
						<div class="card">
							{{-- <div class="card-header" > <h5>List Of Support Links</h5></div> --}}
							<div class="card-header" > <h5>List Of Consumer Services Links</h5></div>
							<div class="card-body">
								@if($links->count() == 0)
									<div class="col-md-12">
									...
									<div class="row">
										...
										<div class="col-md-12 col-sm-12">
											<div class="cf nestable-lists">
												<div class="dd" id="nestable" ajax-url="/cms/ajax_menu_update/SupportLink">
													<ol class="dd-list">
														{!! recursiveLinksMenu('0','SupportLink') !!}
													</ol>
									            ...
									            <div class="modal-content">
									                ...
									                <div class="modal-body">
																		{!! Form::model($link, ['route' => ['cms.support_links.update', $link->id], 'method' => 'PATCH']) !!}
																			...
																			@include('cms.support_links._form', ['submitButton' => "Update"])
