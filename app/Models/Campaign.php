...
class Campaign extends Model implements TrackableInterface{
  ...
  protected $translatableAttributes = ['title','content','summary'];
	...
	{
		return $this->hasMany('App\Models\DocumentCategory', 'campaigns', 'id')->with('documents')->orderBy('created_at', 'DESC');
	}
}
